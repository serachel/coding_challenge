...
describe("EmailInput Component", () => {
  ...
  it("should visualize error for invalid input", () => {
    ...
    cy.get('[data-testid="error-span-invalid-email"]')
      .should("be.visible")
      .contains("Bitte geben Sie eine gültige E-Mail-Adresse ein.");
  });
  ...
  it("should visualize error for empty input", () => {
    ...
    cy.get('[data-testid="email-input"]')
      .should("be.visible")
      .type("test{backspace}{backspace}{backspace}{backspace}", { force: true });
    cy.get('[data-testid="error-empty-input"]')
      .should("be.visible")
      .contains("Dieses Feld ist ein Pflichtfeld.");
  });
});
